...
public class ParticleTypesFactory {
    ...
    public static final SimpleParticleType TYRESMOKE = Registry.register(BuiltInRegistries.PARTICLE_TYPE, ResourceLocation.fromNamespaceAndPath(EntStupidStuff.MOD_ID, "tyre_smoke"), FabricParticleTypes.simple());
