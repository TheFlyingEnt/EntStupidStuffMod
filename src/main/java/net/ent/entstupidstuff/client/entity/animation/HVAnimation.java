...
public class HVAnimation {
	public static final AnimationDefinition IDLE = AnimationDefinition.Builder.create(2.0F).looping()
		.addBoneAnimation("hovering_inferno", new Transformation(Transformation.Targets.MOVE_ORIGIN, 
	...
	public static final AnimationDefinition ATTACK = AnimationDefinition.Builder.create(1.05F)
