...
public class MountaineerPillagerEntity extends Pillager{

    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(MountaineerPillagerEntity.class, EntityDataSerializers.INT);
    ...
    public MountaineerPillagerEntity(EntityType<? extends Pillager> entityType, Level world) {
    ...
    public static AttributeSupplier.Builder createMountaineerPillagerAttributes() {
    ...
    protected void readAdditionalSaveData(ValueInput view) {
        ...
        this.setVariant((MountaineerPillagerEntity.Variant)view.read("Variant", MountaineerPillagerEntity.Variant.INDEX_CODEC).orElse(MountaineerPillagerEntity.Variant.GOLD));
    }

	public void setVariant(MountaineerPillagerEntity.Variant variant) {
