...
public class ArmoredVindicatorEntity extends Vindicator {

    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(ArmoredVindicatorEntity.class, EntityDataSerializers.INT);
    ...
    protected void readAdditionalSaveData(ValueInput view) {
        ...
        this.setVariant((ArmoredVindicatorEntity.Variant)view.read("Variant", ArmoredVindicatorEntity.Variant.INDEX_CODEC).orElse(ArmoredVindicatorEntity.Variant.GOLD));
    }

    public void setVariant(ArmoredVindicatorEntity.Variant variant) {
