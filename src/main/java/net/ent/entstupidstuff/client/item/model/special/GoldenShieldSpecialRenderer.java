...
public class GoldenShieldSpecialRenderer implements SpecialModelRenderer<DataComponentMap> {
    ...
    public GoldenShieldSpecialRenderer(MaterialSet spriteHolder, StrongShieldEntityModel model) {
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        ...
        @Override
        public MapCodec<GoldenShieldSpecialRenderer.Unbaked> type() {
            return CODEC;
        }
