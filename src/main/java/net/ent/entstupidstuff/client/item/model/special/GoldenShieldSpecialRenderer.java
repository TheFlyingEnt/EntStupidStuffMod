...
public class GoldenShieldSpecialRenderer implements SpecialModelRenderer<ComponentMap> {
    ...
    public GoldenShieldSpecialRenderer(SpriteHolder spriteHolder, StrongShieldEntityModel model) {
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        public static final GoldenShieldSpecialRenderer.Unbaked INSTANCE = new GoldenShieldSpecialRenderer.Unbaked();
        public static final MapCodec<GoldenShieldSpecialRenderer.Unbaked> CODEC = MapCodec.unit(INSTANCE);
        
        @Override
        public MapCodec<GoldenShieldSpecialRenderer.Unbaked> getCodec() {
            return CODEC;
        }
        
        @Override
        public SpecialModelRenderer<?> bake(SpecialModelRenderer.BakeContext context) {
            return new GoldenShieldSpecialRenderer(
