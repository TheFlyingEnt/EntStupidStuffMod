...
public class WoodenShieldSpecialRenderer implements SpecialModelRenderer<ComponentMap> {

    public static final SpriteIdentifier MAIN_SHIELD_BASE = new SpriteIdentifier(
		TexturedRenderLayers.SHIELD_PATTERNS_ATLAS_TEXTURE, Identifier.of("entstupidstuff", "entity/shield/wooden_shield_base")
	);
	public static final SpriteIdentifier MAIN_SHIELD_BASE_NO_PATTERN = new SpriteIdentifier(
		TexturedRenderLayers.SHIELD_PATTERNS_ATLAS_TEXTURE, Identifier.of("entstupidstuff", "entity/shield/wooden_shield_base_no_pattern")
	);
    
    private final SpriteHolder spriteHolder;
    private final StrongShieldEntityModel model;
    
    public WoodenShieldSpecialRenderer(SpriteHolder spriteHolder, StrongShieldEntityModel model) {
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        public static final WoodenShieldSpecialRenderer.Unbaked INSTANCE = new WoodenShieldSpecialRenderer.Unbaked();
        public static final MapCodec<WoodenShieldSpecialRenderer.Unbaked> CODEC = MapCodec.unit(INSTANCE);
        
        @Override
        public MapCodec<WoodenShieldSpecialRenderer.Unbaked> getCodec() {
            return CODEC;
        }
        
        @Override
        public SpecialModelRenderer<?> bake(SpecialModelRenderer.BakeContext context) {
            return new WoodenShieldSpecialRenderer(
