...
public class NetheriteShieldSpecialRenderer implements SpecialModelRenderer<DataComponentMap> {

    public static final Material MAIN_SHIELD_BASE = new Material(
		Sheets.SHIELD_SHEET, ResourceLocation.fromNamespaceAndPath("entstupidstuff", "entity/shield/netherite_shield_base")
	);
	public static final Material MAIN_SHIELD_BASE_NO_PATTERN = new Material(
		Sheets.SHIELD_SHEET, ResourceLocation.fromNamespaceAndPath("entstupidstuff", "entity/shield/netherite_shield_base_no_pattern")
	);
    
    private final MaterialSet spriteHolder;
    private final StrongShieldEntityModel model;
    
    public NetheriteShieldSpecialRenderer(MaterialSet spriteHolder, StrongShieldEntityModel model) {
