...
public class NetheriteShieldSpecialRenderer implements SpecialModelRenderer<ComponentMap> {

    public static final SpriteIdentifier MAIN_SHIELD_BASE = new SpriteIdentifier(
		TexturedRenderLayers.SHIELD_PATTERNS_ATLAS_TEXTURE, Identifier.of("entstupidstuff", "entity/shield/netherite_shield_base")
	);
	public static final SpriteIdentifier MAIN_SHIELD_BASE_NO_PATTERN = new SpriteIdentifier(
		TexturedRenderLayers.SHIELD_PATTERNS_ATLAS_TEXTURE, Identifier.of("entstupidstuff", "entity/shield/netherite_shield_base_no_pattern")
	);
    
    private final SpriteHolder spriteHolder;
    private final StrongShieldEntityModel model;
    
    public NetheriteShieldSpecialRenderer(SpriteHolder spriteHolder, StrongShieldEntityModel model) {
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        ...
        public static final MapCodec<NetheriteShieldSpecialRenderer.Unbaked> CODEC = MapCodec.unit(INSTANCE);
        
        @Override
        public MapCodec<NetheriteShieldSpecialRenderer.Unbaked> getCodec() {
            return CODEC;
        }
