...
public class IronShieldSpecialRenderer implements SpecialModelRenderer<ComponentMap> {

    public static final SpriteIdentifier MAIN_SHIELD_BASE = new SpriteIdentifier(
		TexturedRenderLayers.SHIELD_PATTERNS_ATLAS_TEXTURE, Identifier.of("entstupidstuff", "entity/shield/iron_shield_base")
	);
	public static final SpriteIdentifier MAIN_SHIELD_BASE_NO_PATTERN = new SpriteIdentifier(
		TexturedRenderLayers.SHIELD_PATTERNS_ATLAS_TEXTURE, Identifier.of("entstupidstuff", "entity/shield/iron_shield_base_no_pattern")
	);
    
    private final SpriteHolder spriteHolder;
    private final StrongShieldEntityModel model;
    
    public IronShieldSpecialRenderer(SpriteHolder spriteHolder, StrongShieldEntityModel model) {
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        public static final IronShieldSpecialRenderer.Unbaked INSTANCE = new IronShieldSpecialRenderer.Unbaked();
        public static final MapCodec<IronShieldSpecialRenderer.Unbaked> CODEC = MapCodec.unit(INSTANCE);
        
        @Override
        public MapCodec<IronShieldSpecialRenderer.Unbaked> getCodec() {
            return CODEC;
        }
        
        @Override
        public SpecialModelRenderer<?> bake(SpecialModelRenderer.BakeContext context) {
            return new IronShieldSpecialRenderer(
