...
public class IronShieldSpecialRenderer implements SpecialModelRenderer<DataComponentMap> {

    public static final Material MAIN_SHIELD_BASE = new Material(
		Sheets.SHIELD_SHEET, ResourceLocation.fromNamespaceAndPath("entstupidstuff", "entity/shield/iron_shield_base")
	);
	public static final Material MAIN_SHIELD_BASE_NO_PATTERN = new Material(
		Sheets.SHIELD_SHEET, ResourceLocation.fromNamespaceAndPath("entstupidstuff", "entity/shield/iron_shield_base_no_pattern")
	);
    
    private final MaterialSet spriteHolder;
    private final StrongShieldEntityModel model;
    
    public IronShieldSpecialRenderer(MaterialSet spriteHolder, StrongShieldEntityModel model) {
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        ...
        @Override
        public MapCodec<IronShieldSpecialRenderer.Unbaked> type() {
            return CODEC;
        }
