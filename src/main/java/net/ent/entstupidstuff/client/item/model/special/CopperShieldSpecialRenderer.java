...
public class CopperShieldSpecialRenderer implements SpecialModelRenderer<ComponentMap> {

    public static final SpriteIdentifier MAIN_SHIELD_BASE = new SpriteIdentifier(
		TexturedRenderLayers.SHIELD_PATTERNS_ATLAS_TEXTURE, Identifier.of("entstupidstuff", "entity/shield/copper_shield_base")
	);
	public static final SpriteIdentifier MAIN_SHIELD_BASE_NO_PATTERN = new SpriteIdentifier(
		TexturedRenderLayers.SHIELD_PATTERNS_ATLAS_TEXTURE, Identifier.of("entstupidstuff", "entity/shield/copper_shield_base_no_pattern")
	);
    
    private final SpriteHolder spriteHolder;
    private final StrongShieldEntityModel model;
    
    public CopperShieldSpecialRenderer(SpriteHolder spriteHolder, StrongShieldEntityModel model) {
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        public static final CopperShieldSpecialRenderer.Unbaked INSTANCE = new CopperShieldSpecialRenderer.Unbaked();
        public static final MapCodec<CopperShieldSpecialRenderer.Unbaked> CODEC = MapCodec.unit(INSTANCE);
        
        @Override
        public MapCodec<CopperShieldSpecialRenderer.Unbaked> getCodec() {
            return CODEC;
        }
        
        @Override
        public SpecialModelRenderer<?> bake(SpecialModelRenderer.BakeContext context) {
            return new CopperShieldSpecialRenderer(
