...
public class ModEntityModelLayers {
    ...
    public static final EntityModelLayer ZOMBIE_FUNGAL =
    new EntityModelLayer(Identifier.of(EntStupidStuff.MOD_ID, "zombie_fungal"), "main");

    public static final EntityModelLayer ZOMBIE_FUNGAL_BABY =
    new EntityModelLayer(Identifier.of(EntStupidStuff.MOD_ID, "zombie_fungal_baby"), "main");

    public static final EntityModelLayer ZOMBIE_FUNGAL_OUTER =
    new EntityModelLayer(Identifier.of(EntStupidStuff.MOD_ID, "zombie_fungal"), "outer");

    public static final EntityModelLayer ZOMBIE_FUNGAL_OUTER_BABY =
    new EntityModelLayer(Identifier.of(EntStupidStuff.MOD_ID, "zombie_fungal_baby"), "outer");

    public static final EntityModelLayer FUNGAL_SKELTON =
    new EntityModelLayer(Identifier.of(EntStupidStuff.MOD_ID, "fungal_skeleton"), "main");

    public static final EntityModelLayer FUNGAL_SKELTON_OUTER =
    new EntityModelLayer(Identifier.of(EntStupidStuff.MOD_ID, "fungal_skeleton"), "outer");

    public static final EntityModelLayer SPOREPER =
    new EntityModelLayer(Identifier.of(EntStupidStuff.MOD_ID, "sporeper"), "main");
    ...
    public static void onInitialize() {
        ...
        EntityRendererFactories.register(EntityFactory.ZOMBIE_FUNGAL, (EntityRendererFactory.Context context) -> new FungalZombieEntityRenderer(context));
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.ZOMBIE_FUNGAL, () -> DrownedEntityModel.getTexturedModelData(Dilation.NONE));
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.ZOMBIE_FUNGAL_OUTER, () -> DrownedEntityModel.getTexturedModelData(new Dilation(0.5F)));
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.ZOMBIE_FUNGAL_BABY, () -> DrownedEntityModel.getTexturedModelData(Dilation.NONE).transform(BipedEntityModel.BABY_TRANSFORMER));
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.ZOMBIE_FUNGAL_OUTER_BABY, () -> DrownedEntityModel.getTexturedModelData(new Dilation(0.5F)).transform(BipedEntityModel.BABY_TRANSFORMER));

        EntityRendererFactories.register(EntityFactory.FUNGAL_SKELETON, (EntityRendererFactory.Context context) -> new FungalSkeletonEntityRender(context));
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.FUNGAL_SKELTON, () -> SkeletonEntityModel.getTexturedModelData());
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.FUNGAL_SKELTON_OUTER, () -> SkeletonEntityModel.getTexturedModelData().of(BipedEntityModel.getModelData(new Dilation(0.25F), 0.0F), 64, 32));
        ...
        EntityRendererFactories.register(EntityFactory.SPOREPER, (EntityRendererFactory.Context context) -> new SporeperRenderer(context));
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.SPOREPER, () ->  SporeperModel.getTexturedModelData(new Dilation(0.5F)));
