...
public class ModEntityModelLayers {
    ...
    public static final ModelLayerLocation FUNGAL_SKELTON =
    new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(EntStupidStuff.MOD_ID, "fungal_skeleton"), "main");

    public static final ModelLayerLocation FUNGAL_SKELTON_OUTER =
    new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(EntStupidStuff.MOD_ID, "fungal_skeleton"), "outer");
    ...
    public static void onInitialize() {
        ...
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.ZOMBIE_SLIMED_BABY, () -> SlimedZombieModel.getTexturedModelData(CubeDeformation.NONE));
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.ZOMBIE_SLIMED_OUTER_BABY, () -> SlimedZombieModel.getTexturedModelData(new CubeDeformation(0.25F)));
        ...
        EntityRenderers.register(EntityFactory.FUNGAL_SKELETON, (EntityRendererProvider.Context context) -> new FungalSkeletonEntityRender(context));
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.FUNGAL_SKELTON, () -> SkeletonModel.createBodyLayer());
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.FUNGAL_SKELTON_OUTER, () -> SkeletonModel.createBodyLayer().create(HumanoidModel.createMesh(new CubeDeformation(0.25F), 0.0F), 64, 32));
        ...
        EntityRenderers.register(EntityFactory.METAL_SKELETON, (EntityRendererProvider.Context context) -> new MetalSkeletonRenderer(context, ModEntityModelLayers.METAL_SKELETON, ModelLayers.SKELETON_ARMOR));
