...
public class FrostbittenZombieModel extends ZombieEntityModel<FrostbittenEntityRenderState> {
	...
	@Override
	public void setAngles(FrostbittenEntityRenderState zombieEntityRenderState) {
