...
public class MackerelModel extends EntityModel<LivingEntityRenderState> {
   ...
   public static LayerDefinition getTexturedModelData() {
      ...
      modelPartData.addOrReplaceChild("top_fin", CubeListBuilder.create().texOffs(0, 4).addBox(0.0F, -1.0F, -1.0F, 0.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 20.0F, 0.0F));
