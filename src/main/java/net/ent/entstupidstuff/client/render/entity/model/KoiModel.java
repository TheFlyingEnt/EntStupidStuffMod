...
public class KoiModel <T extends Entity> extends SinglePartEntityModel<T>{
    ...
    public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(20, 27).cuboid(0.0F, 3.0F, 2.0F, 0.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(2, 2).cuboid(-2.0F, -1.0F, 0.0F, 4.0F, 4.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 20.25F, -6.0F));

		ModelPartData head = modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 21).cuboid(-1.5F, -2.75F, -5.0F, 3.0F, 3.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 22.5F, -4.0F));

		ModelPartData right_wisker = modelPartData.addChild("right_wisker", ModelPartBuilder.create().uv(11, 14).cuboid(0.0F, 0.0F, -2.0F, 3.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(1.5F, 22.75F, -8.0F, 0.0F, 0.0F, 0.7854F));

		ModelPartData left_wisker = modelPartData.addChild("left_wisker", ModelPartBuilder.create().uv(8, 21).mirrored().cuboid(-3.0F, 0.0F, -2.0F, 3.0F, 0.0F, 3.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-1.5F, 22.75F, -8.0F, 0.0F, 0.0F, -0.7854F));

		ModelPartData left_fin = modelPartData.addChild("left_fin", ModelPartBuilder.create().uv(23, 8).cuboid(-4.3473F, 1.9696F, -1.0F, 3.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 21.0F, -4.0F, 0.0F, 0.0F, -0.1745F));

		ModelPartData right_fin = modelPartData.addChild("right_fin", ModelPartBuilder.create().uv(23, 11).cuboid(1.3473F, 1.9696F, 0.0F, 3.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(1.0F, 21.0F, -5.0F, 0.0F, 0.0F, 0.1745F));

		ModelPartData tail_fin = modelPartData.addChild("tail_fin", ModelPartBuilder.create().uv(0, 7).cuboid(0.0F, -3.0F, 6.0F, 0.0F, 7.0F, 7.0F, new Dilation(0.0F))
		.uv(19, 16).cuboid(-1.5F, -1.0F, 0.0F, 3.0F, 4.0F, 3.0F, new Dilation(0.0F))
		.uv(18, 18).cuboid(0.0F, -4.0F, 0.0F, 0.0F, 7.0F, 6.0F, new Dilation(0.0F))
		.uv(19, 1).cuboid(-1.5F, -1.0F, 3.0F, 3.0F, 3.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 20.25F, 0.0F));

		ModelPartData back_right_fin = tail_fin.addChild("back_right_fin", ModelPartBuilder.create().uv(28, 15).cuboid(0.0F, 0.0F, 0.0F, 0.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(1.0F, 3.0F, 1.0F, 0.0F, 0.0F, -0.7854F));

		ModelPartData back_left_fin = tail_fin.addChild("back_left_fin", ModelPartBuilder.create().uv(28, 13).cuboid(0.0F, 0.0F, 0.0F, 0.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 3.0F, 1.0F, 0.0F, 0.0F, 0.7854F));

		ModelPartData top_fin = modelPartData.addChild("top_fin", ModelPartBuilder.create().uv(2, 23).cuboid(0.0F, -6.0F, -2.0F, 0.0F, 3.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 22.25F, -4.0F));
	...
	public void setAngles(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
		...
		this.tailFin.yaw = -f * 0.25F * MathHelper.sin(g * 0.6F * animationProgress);
	}
