...
public class KoiModel extends EntityModel<LivingEntityRenderState>{
    ...
    public static TexturedModelData getTexturedModelData() {
		...
		.uv(2, 2).cuboid(-2.0F, -1.0F, 0.0F, 4.0F, 4.0F, 6.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 20.25F, -6.0F));

		ModelPartData head = modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 21).cuboid(-1.5F, -2.75F, -5.0F, 3.0F, 3.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 22.5F, -4.0F));
		...
		.uv(19, 1).cuboid(-1.5F, -1.0F, 3.0F, 3.0F, 3.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 20.25F, 0.0F));
		...
		ModelPartData top_fin = modelPartData.addChild("top_fin", ModelPartBuilder.create().uv(2, 23).cuboid(0.0F, -6.0F, -2.0F, 0.0F, 3.0F, 6.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 22.25F, -4.0F));
