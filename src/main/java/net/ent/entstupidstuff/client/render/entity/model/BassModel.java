...
public class BassModel extends EntityModel<LivingEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
		ModelData modelData = new ModelData();
		ModelPartData modelPartData = modelData.getRoot();
		ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(2, 2).cuboid(-2.0F, -3.0F, -1.0F, 4.0F, 6.0F, 6.0F, new Dilation(0.0F))
		.uv(6, 7).cuboid(-2.0F, -2.0F, 5.0F, 4.0F, 5.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 21.0F, 0.0F));
		...
		ModelPartData nose = modelPartData.addChild("nose", ModelPartBuilder.create().uv(0, 15).cuboid(-2.0F, -1.0F, -3.0F, 3.0F, 4.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(0.5F, 20.5F, -5.0F));
		return TexturedModelData.of(modelData, 32, 32);
	}
