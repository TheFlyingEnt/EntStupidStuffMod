...
public class BassModel <T extends Entity> extends SinglePartEntityModel<T>{
    ...
    public static TexturedModelData getTexturedModelData() {
		...
		.uv(6, 7).cuboid(-2.0F, -2.0F, 5.0F, 4.0F, 5.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 21.0F, 0.0F));
		...
		ModelPartData nose = modelPartData.addChild("nose", ModelPartBuilder.create().uv(0, 15).cuboid(-2.0F, -1.0F, -3.0F, 3.0F, 4.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(0.5F, 20.5F, -5.0F));
		return TexturedModelData.of(modelData, 32, 32);
	}
