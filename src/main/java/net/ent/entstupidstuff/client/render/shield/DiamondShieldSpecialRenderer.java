package net.ent.entstupidstuff.client.render.shield;
...
public class DiamondShieldSpecialRenderer implements SpecialModelRenderer<ComponentMap> {
    ...
    // Your custom shield textures
    /*public static final SpriteIdentifier DIAMOND_SHIELD_BASE = new SpriteIdentifier(
        SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE,
        Identifier.of("entstupidstuff", "entity/shield/diamond_shield_base")
    );
    
    public static final SpriteIdentifier DIAMOND_SHIELD_BASE_NO_PATTERN = new SpriteIdentifier(
        SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE,
        Identifier.of("entstupidstuff", "entity/shield/diamond_shield_base_no_pattern")
    );*/
    ...
    public void render(
        ...
        SpriteIdentifier spriteIdentifier = hasBanner ? DIAMOND_SHIELD_BASE : DIAMOND_SHIELD_BASE_NO_PATTERN;
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        public static final DiamondShieldSpecialRenderer.Unbaked INSTANCE = new DiamondShieldSpecialRenderer.Unbaked();
        ...
        public SpecialModelRenderer<?> bake(SpecialModelRenderer.BakeContext context) {
            return new DiamondShieldSpecialRenderer(
                ...
                new StrongShieldEntityModel(context.entityModelSet().getModelPart(ModEntityModelLayers.DIAMOND_SHIELD)) // <-- USE YOUR LAYER HERE
            );
        }
    }
}
