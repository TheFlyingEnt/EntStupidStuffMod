...
public class HoveringInfernoModel extends EntityModel<LivingEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData hovering_inferno = modelPartData.addChild("hovering_inferno", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 8.0F, 0.0F));
		...
		.uv(32, 0).cuboid(-4.5F, -10.5F, -4.5F, 9.0F, 15.0F, 9.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -24.0F, 0.0F));

		ModelPartData inferno_shield = hovering_inferno.addChild("inferno_shield", ModelPartBuilder.create().uv(0, 34).cuboid(-2.0F, -9.7524F, -1.8177F, 4.0F, 30.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -7.2476F, -0.1823F));
