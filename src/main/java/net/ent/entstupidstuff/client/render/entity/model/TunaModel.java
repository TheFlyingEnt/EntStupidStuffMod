...
public class TunaModel <T extends Entity> extends SinglePartEntityModel<T> {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData.addChild("right_fin", ModelPartBuilder.create().uv(22, 2).cuboid(-2.0F, 0.0F, -1.0F, 2.0F, 0.0F, 2.0F), ModelTransform.of(-1.0F, 23.0F, 0.0F, 0.0F, 0.0F, -0.7853982F));
      ...
      modelPartData.addChild("top_fin", ModelPartBuilder.create().uv(20, -6).cuboid(0.0F, -1.0F, -1.0F, 0.0F, 2.0F, 6.0F), ModelTransform.pivot(0.0F, 20.0F, 0.0F));
