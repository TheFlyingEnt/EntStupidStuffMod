...
public class DarkEnchantingTableHandler extends ScreenHandler {
	static final Identifier EMPTY_LAPIS_SLOT_TEXTURE = Identifier.ofVanilla("item/empty_slot_lapis_lazuli");
	private final Inventory inventory = new SimpleInventory(2) {
		@Override
		public void markDirty() {
			super.markDirty();
			DarkEnchantingTableHandler.this.onContentChanged(this);
		}
	};
	...
	public DarkEnchantingTableHandler(int syncId, PlayerInventory playerInventory) {
		this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
	}

	public DarkEnchantingTableHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
		...
		this.addSlot(new Slot(this.inventory, 1, 35, 47) {
			...
			public Pair<Identifier, Identifier> getBackgroundSprite() {
				return Pair.of(PlayerScreenHandler.BLOCK_ATLAS_TEXTURE, DarkEnchantingTableHandler.EMPTY_LAPIS_SLOT_TEXTURE);
			}
		});
