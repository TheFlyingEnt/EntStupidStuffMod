...
public class Mustang77EntityModel extends BaseCarEntityModel<BaseCarRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		.texOffs(142, 187).addBox(-2.4066F, -5.5554F, -12.8096F, 11.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(302, 88).addBox(-2.4066F, -4.5554F, -15.8096F, 11.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
		...
		.texOffs(1, 48).addBox(-26.4066F, -14.0554F, -5.8096F, 19.0F, 2.0F, 25.0F, new CubeDeformation(0.0F))
		.texOffs(18, 48).addBox(-9.4066F, -14.0554F, -5.8096F, 20.0F, 2.0F, 25.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(304, 48).addBox(-30.012F, 12.0942F, -45.0509F, 2.0F, 8.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.6054F, -3.1496F, -2.7587F, 0.0F, 0.0F, 0.3927F));
		...
		.texOffs(312, 307).addBox(-15.9776F, 5.0942F, -9.0784F, 2.0F, 5.0F, 9.0F, new CubeDeformation(0.0F))
		.texOffs(104, 261).mirror().addBox(-15.9776F, 5.0942F, 24.9216F, 2.0F, 5.0F, 17.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(264, 278).mirror().addBox(-15.9776F, 5.0942F, 41.9216F, 2.0F, 3.0F, 13.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(318, 143).mirror().addBox(-15.9776F, 5.0942F, 54.9216F, 2.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-10.679F, -3.6496F, -12.7311F, 0.0F, 0.0F, 0.3927F));
		...
		.texOffs(212, 311).addBox(-17.9776F, -3.9058F, 23.0272F, 3.0F, 9.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(310, 248).mirror().addBox(-17.9776F, -3.9058F, 86.0272F, 3.0F, 9.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(160, 260).mirror().addBox(-17.9776F, -3.9058F, 55.0272F, 3.0F, 9.0F, 15.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-11.179F, -3.7496F, -42.8367F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(170, 303).addBox(28.012F, 12.0942F, -45.0509F, 2.0F, 8.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-22.4186F, -3.1496F, -2.7587F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r4 = body.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(102, 321).addBox(-2.0F, -1.0F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.9549F, 3.9446F, -47.346F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r5 = body.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(316, 240).addBox(-7.0F, -1.0F, -6.0F, 7.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-14.8403F, 3.9446F, -53.1838F, 0.0F, 1.7453F, 0.0F));

		PartDefinition cube_r6 = body.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(246, 338).addBox(-0.0351F, -1.0F, -2.9875F, 4.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-22.7604F, 3.9446F, -52.1487F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r7 = body.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(296, 22).addBox(0.0F, -1.0F, -6.0F, 7.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.8729F, 3.9446F, -53.1838F, 0.0F, -1.7453F, 0.0F));

		PartDefinition cube_r8 = body.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(260, 88).addBox(-0.0351F, -1.0F, -11.9875F, 7.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-12.8604F, 3.9446F, -53.1487F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r9 = body.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(134, 326).addBox(-0.005F, -1.001F, -3.9799F, 6.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-26.4604F, 3.9446F, -50.6487F, 0.0F, -1.1781F, 0.0F));

		PartDefinition cube_r10 = body.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(252, 326).addBox(0.0F, -1.0F, -4.0F, 5.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-29.3066F, 3.9446F, -47.8096F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r11 = body.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(96, 113).addBox(-3.9649F, -1.0F, -2.9875F, 4.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0472F, 3.9446F, -52.1487F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r12 = body.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(326, 54).addBox(-5.995F, -1.001F, -3.9799F, 6.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(10.7472F, 3.9446F, -50.6487F, 0.0F, 1.1781F, 0.0F));

		PartDefinition cube_r13 = body.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(192, 303).addBox(-5.0F, -1.0F, -4.0F, 5.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(13.5934F, 3.9446F, -47.8096F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r14 = body.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(232, 278).mirror().addBox(-1.0F, -1.2475F, -2.5099F, 2.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(10.5934F, -5.0538F, -13.0991F, 0.7873F, -0.0617F, -0.0618F));

		PartDefinition cube_r15 = body.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(232, 278).addBox(-1.0F, -1.2475F, -2.5099F, 2.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-26.4066F, -5.0538F, -13.0991F, 0.7873F, 0.0617F, 0.0618F));

		PartDefinition cube_r16 = body.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(225, 116).addBox(15.012F, -9.9058F, 4.9491F, 17.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(206, 116).addBox(-3.988F, -9.9058F, 4.9491F, 19.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-22.4186F, -2.8496F, -3.0587F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r17 = body.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(304, 132).mirror().addBox(-2.0F, -0.01F, -8.9695F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(304, 132).addBox(37.0F, -0.01F, -8.9695F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-27.4066F, 1.6301F, 25.0691F, 1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r18 = body.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(314, 97).mirror().addBox(-2.0F, 0.0F, -8.0F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition cube_r19 = body.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(314, 107).mirror().addBox(-2.0F, 0.0F, 0.0F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition cube_r20 = body.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(0, 305).mirror().addBox(-2.0F, -0.01F, -0.0305F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(0, 305).addBox(37.0F, -0.01F, -0.0305F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-27.4066F, 1.6301F, 46.4117F, -1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r21 = body.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(304, 132).mirror().addBox(-2.0F, -0.01F, -8.9695F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(304, 132).addBox(37.0F, -0.01F, -8.9695F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-27.4066F, 1.6301F, -38.9309F, 1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r22 = body.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(314, 97).mirror().addBox(-2.0F, 0.0F, -8.0F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition cube_r23 = body.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(314, 107).mirror().addBox(-2.0F, 0.0F, 0.0F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition cube_r24 = body.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(0, 305).mirror().addBox(-2.0F, -0.01F, -0.0305F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(0, 305).addBox(37.0F, -0.01F, -0.0305F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-27.4066F, 1.6301F, -17.5883F, -1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r25 = body.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(206, 74).addBox(-2.749F, -7.3541F, -7.6679F, 3.0F, 11.0F, 24.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.3434F, -4.5283F, 23.8966F, -0.3491F, 0.0F, -0.1047F));

		PartDefinition cube_r26 = body.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(26, 286).addBox(-1.751F, -10.603F, -3.6505F, 2.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.3434F, -4.5283F, 23.8966F, 0.3927F, 0.0F, -0.1047F));

		PartDefinition cube_r27 = body.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(304, 118).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.5924F, -4.7708F, 17.0802F, 0.3892F, -0.0065F, -0.1442F));

		PartDefinition cube_r28 = body.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(304, 118).mirror().addBox(0.0F, -2.0F, -5.0F, 2.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-27.4056F, -4.7708F, 17.0802F, 0.3892F, 0.0065F, 0.1442F));

		PartDefinition cube_r29 = body.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(26, 286).mirror().addBox(-0.249F, -10.603F, -3.6505F, 2.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-27.1566F, -4.5283F, 23.8966F, 0.3927F, 0.0F, 0.1047F));

		PartDefinition cube_r30 = body.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(84, 177).addBox(-19.25F, -1.95F, -5.0F, 39.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(84, 177).addBox(-19.25F, -0.95F, -5.0F, 39.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.1566F, -4.6001F, 50.2553F, 0.2793F, 0.0F, 0.0F));

		PartDefinition glass_r2 = body.addOrReplaceChild("glass_r2", CubeListBuilder.create().texOffs(156, 312).addBox(0.0F, -9.5F, 4.75F, 0.0F, 11.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(10.5934F, -4.5554F, 7.4404F, 0.0F, 0.0F, -0.0873F));

		PartDefinition glass_r3 = body.addOrReplaceChild("glass_r3", CubeListBuilder.create().texOffs(142, 261).addBox(0.0F, -9.5F, 4.75F, 0.0F, 11.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-26.4066F, -4.5554F, 7.4404F, 0.0F, 0.0F, 0.0524F));

		PartDefinition cube_r31 = body.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(206, 109).addBox(-3.988F, -13.9058F, 49.9491F, 36.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-22.4186F, -3.1496F, -3.0087F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r32 = body.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(242, 30).addBox(-17.988F, 5.3442F, 7.9491F, 36.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.4186F, -13.9496F, 20.2413F, 0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r33 = body.addOrReplaceChild("cube_r33", CubeListBuilder.create().texOffs(228, 68).addBox(-17.988F, 3.3442F, 4.9491F, 36.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.4186F, -15.6996F, 14.9913F, 0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r34 = body.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(228, 68).addBox(-17.988F, 3.3442F, 4.9491F, 36.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.4186F, -13.9496F, 19.2413F, 0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r35 = body.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(206, 74).mirror().addBox(-0.251F, -7.3541F, -7.6679F, 3.0F, 11.0F, 24.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-27.1566F, -4.5283F, 23.8966F, -0.3491F, 0.0F, 0.1047F));

		PartDefinition glass_r4 = body.addOrReplaceChild("glass_r4", CubeListBuilder.create().texOffs(96, 118).addBox(-15.988F, 1.4911F, -0.2433F, 33.0F, 0.0F, 21.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.4186F, -13.9496F, 19.2413F, -0.3491F, 0.0F, 0.0F));

		PartDefinition cube_r36 = body.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(174, 165).addBox(-15.988F, -0.0932F, 13.9289F, 33.0F, 11.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.4186F, -13.4496F, 19.2413F, -0.3491F, 0.0F, 0.0F));

		PartDefinition cube_r37 = body.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(16, 326).addBox(22.012F, -9.9058F, -45.0509F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r38 = body.addOrReplaceChild("cube_r38", CubeListBuilder.create().texOffs(228, 62).addBox(-2.988F, -9.9058F, -45.0509F, 35.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-22.4186F, -3.1496F, -4.7587F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r39 = body.addOrReplaceChild("cube_r39", CubeListBuilder.create().texOffs(277, 104).addBox(30.012F, 3.0942F, -10.0509F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(310, 264).addBox(20.012F, 3.0942F, -10.0509F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-22.4186F, -4.3496F, -2.2087F, -0.3927F, 0.0F, 0.0F));

		PartDefinition glass_r5 = body.addOrReplaceChild("glass_r5", CubeListBuilder.create().texOffs(308, 230).addBox(12.012F, 9.0942F, -5.0509F, 8.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-22.4186F, -3.1496F, -2.7587F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r40 = body.addOrReplaceChild("cube_r40", CubeListBuilder.create().texOffs(1, 190).addBox(-3.988F, 7.0942F, -11.0509F, 37.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-22.4186F, -3.1496F, -2.7587F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r41 = body.addOrReplaceChild("cube_r41", CubeListBuilder.create().texOffs(306, 45).addBox(14.012F, -5.9058F, -10.0509F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(260, 104).addBox(14.012F, -2.9058F, -13.0509F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(278, 158).addBox(14.012F, -5.9058F, -13.0509F, 18.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(258, 141).addBox(-3.988F, -5.9058F, -13.0509F, 18.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(194, 339).addBox(31.012F, -5.9058F, -11.0509F, 1.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(252, 319).addBox(18.012F, -5.9058F, -11.0509F, 2.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-22.4186F, -3.1496F, -2.7587F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r42 = body.addOrReplaceChild("cube_r42", CubeListBuilder.create().texOffs(254, 211).addBox(-7.988F, -3.0058F, -0.0009F, 19.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.4186F, -3.0496F, -50.8087F, -1.2217F, 0.0F, 0.0F));
		...
		.texOffs(1, 0).addBox(0.8636F, 0.6818F, 0.5624F, 0.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
		...
		.texOffs(1, 0).addBox(2.8636F, -0.3182F, 0.5624F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F))
		.texOffs(1, 0).addBox(0.8636F, -0.3182F, 0.5624F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F))
		.texOffs(1, 0).addBox(1.8636F, -0.3182F, 0.5624F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F))
		.texOffs(1, 0).addBox(-2.1364F, -0.3182F, 0.5624F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F))
		.texOffs(1, 0).addBox(-3.1364F, -0.3182F, 0.5624F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F))
		.texOffs(1, 0).addBox(-1.1364F, -0.3182F, 0.5624F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F))
		...
		PartDefinition Front_Left_Wheel = body.addOrReplaceChild("Front_Left_Wheel", CubeListBuilder.create().texOffs(268, 294).addBox(0.0F, -5.5F, -5.51F, 0.0F, 11.0F, 11.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r43 = Front_Left_Wheel.addOrReplaceChild("cube_r43", CubeListBuilder.create().texOffs(340, 268).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, 1.3F, 3.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r44 = Front_Left_Wheel.addOrReplaceChild("cube_r44", CubeListBuilder.create().texOffs(326, 32).addBox(-0.5F, -1.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, 3.35F, 1.39F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r45 = Front_Left_Wheel.addOrReplaceChild("cube_r45", CubeListBuilder.create().texOffs(268, 340).addBox(-0.5F, -2.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, -1.7F, -3.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r46 = Front_Left_Wheel.addOrReplaceChild("cube_r46", CubeListBuilder.create().texOffs(338, 153).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, 1.3F, -3.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r47 = Front_Left_Wheel.addOrReplaceChild("cube_r47", CubeListBuilder.create().texOffs(322, 32).addBox(-0.5F, -1.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, 3.35F, -1.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r48 = Front_Left_Wheel.addOrReplaceChild("cube_r48", CubeListBuilder.create().texOffs(86, 319).addBox(-0.5F, 0.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, -3.75F, -1.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r49 = Front_Left_Wheel.addOrReplaceChild("cube_r49", CubeListBuilder.create().texOffs(82, 319).addBox(-0.5F, 0.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, -3.75F, 1.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r50 = Front_Left_Wheel.addOrReplaceChild("cube_r50", CubeListBuilder.create().texOffs(336, 325).addBox(-0.5F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, -1.7F, 3.39F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition right_wheel_r2 = Front_Left_Wheel.addOrReplaceChild("right_wheel_r2", CubeListBuilder.create().texOffs(318, 328).addBox(-0.625F, -1.4282F, -7.5452F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.375F, 0.0F, -0.045F, -2.7576F, 0.0F, 0.0F));
		...
		PartDefinition cube_r51 = Front_Right_Wheel.addOrReplaceChild("cube_r51", CubeListBuilder.create().texOffs(340, 268).mirror().addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, 1.3F, 3.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r52 = Front_Right_Wheel.addOrReplaceChild("cube_r52", CubeListBuilder.create().texOffs(326, 32).mirror().addBox(-0.5F, -1.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, 3.35F, 1.39F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r53 = Front_Right_Wheel.addOrReplaceChild("cube_r53", CubeListBuilder.create().texOffs(268, 340).mirror().addBox(-0.5F, -2.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, -1.7F, -3.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r54 = Front_Right_Wheel.addOrReplaceChild("cube_r54", CubeListBuilder.create().texOffs(338, 153).mirror().addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, 1.3F, -3.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r55 = Front_Right_Wheel.addOrReplaceChild("cube_r55", CubeListBuilder.create().texOffs(322, 32).mirror().addBox(-0.5F, -1.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, 3.35F, -1.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r56 = Front_Right_Wheel.addOrReplaceChild("cube_r56", CubeListBuilder.create().texOffs(86, 319).mirror().addBox(-0.5F, 0.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, -3.75F, -1.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r57 = Front_Right_Wheel.addOrReplaceChild("cube_r57", CubeListBuilder.create().texOffs(82, 319).mirror().addBox(-0.5F, 0.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, -3.75F, 1.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r58 = Front_Right_Wheel.addOrReplaceChild("cube_r58", CubeListBuilder.create().texOffs(336, 325).mirror().addBox(-0.5F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, -1.7F, 3.39F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition left_wheel_r2 = Front_Right_Wheel.addOrReplaceChild("left_wheel_r2", CubeListBuilder.create().texOffs(318, 328).mirror().addBox(-4.375F, -1.4282F, -7.5452F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.375F, 0.0F, -0.045F, -2.7576F, 0.0F, 0.0F));
		...
		PartDefinition cube_r59 = Back_Left_Wheel.addOrReplaceChild("cube_r59", CubeListBuilder.create().texOffs(340, 268).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, 1.3F, 3.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r60 = Back_Left_Wheel.addOrReplaceChild("cube_r60", CubeListBuilder.create().texOffs(326, 32).addBox(-0.5F, -1.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, 3.35F, 1.39F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r61 = Back_Left_Wheel.addOrReplaceChild("cube_r61", CubeListBuilder.create().texOffs(268, 340).addBox(-0.5F, -2.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, -1.7F, -3.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r62 = Back_Left_Wheel.addOrReplaceChild("cube_r62", CubeListBuilder.create().texOffs(338, 153).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, 1.3F, -3.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r63 = Back_Left_Wheel.addOrReplaceChild("cube_r63", CubeListBuilder.create().texOffs(322, 32).addBox(-0.5F, -1.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, 3.35F, -1.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r64 = Back_Left_Wheel.addOrReplaceChild("cube_r64", CubeListBuilder.create().texOffs(86, 319).addBox(-0.5F, 0.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, -3.75F, -1.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r65 = Back_Left_Wheel.addOrReplaceChild("cube_r65", CubeListBuilder.create().texOffs(82, 319).addBox(-0.5F, 0.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, -3.75F, 1.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r66 = Back_Left_Wheel.addOrReplaceChild("cube_r66", CubeListBuilder.create().texOffs(336, 325).addBox(-0.5F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, -1.7F, 3.39F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r67 = Back_Right_Wheel.addOrReplaceChild("cube_r67", CubeListBuilder.create().texOffs(340, 268).mirror().addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, 1.3F, 3.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r68 = Back_Right_Wheel.addOrReplaceChild("cube_r68", CubeListBuilder.create().texOffs(326, 32).mirror().addBox(-0.5F, -1.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, 3.35F, 1.39F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r69 = Back_Right_Wheel.addOrReplaceChild("cube_r69", CubeListBuilder.create().texOffs(268, 340).mirror().addBox(-0.5F, -2.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, -1.7F, -3.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r70 = Back_Right_Wheel.addOrReplaceChild("cube_r70", CubeListBuilder.create().texOffs(338, 153).mirror().addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, 1.3F, -3.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r71 = Back_Right_Wheel.addOrReplaceChild("cube_r71", CubeListBuilder.create().texOffs(322, 32).mirror().addBox(-0.5F, -1.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, 3.35F, -1.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r72 = Back_Right_Wheel.addOrReplaceChild("cube_r72", CubeListBuilder.create().texOffs(86, 319).mirror().addBox(-0.5F, 0.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, -3.75F, -1.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r73 = Back_Right_Wheel.addOrReplaceChild("cube_r73", CubeListBuilder.create().texOffs(82, 319).mirror().addBox(-0.5F, 0.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, -3.75F, 1.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r74 = Back_Right_Wheel.addOrReplaceChild("cube_r74", CubeListBuilder.create().texOffs(336, 325).mirror().addBox(-0.5F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, -1.7F, 3.39F, 0.7854F, 0.0F, 0.0F));
		...
		.texOffs(84, 184).mirror().addBox(0.1422F, -4.5802F, -2.0F, 2.0F, 7.0F, 27.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-27.5488F, -0.4752F, -12.8096F));

		PartDefinition glass_r6 = right_door.addOrReplaceChild("glass_r6", CubeListBuilder.create().texOffs(56, 218).addBox(0.0F, -9.5F, -21.25F, 0.0F, 11.0F, 26.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1422F, -4.0802F, 20.25F, 0.0F, 0.0F, 0.0524F));

		PartDefinition left_door_r3 = right_door.addOrReplaceChild("left_door_r3", CubeListBuilder.create().texOffs(0, 234).mirror().addBox(-1.4386F, -1.9287F, -12.0F, 2.0F, 5.0F, 25.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.75F, -2.25F, 12.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition left_door_r4 = right_door.addOrReplaceChild("left_door_r4", CubeListBuilder.create().texOffs(142, 190).mirror().addBox(-3.1548F, 1.1252F, -12.0F, 3.0F, 9.0F, 25.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.75F, -2.25F, 12.0F, 0.0F, 0.0F, -0.3927F));
		...
		PartDefinition glass_r7 = left_door.addOrReplaceChild("glass_r7", CubeListBuilder.create().texOffs(108, 224).addBox(0.0F, -9.5F, -21.25F, 0.0F, 11.0F, 26.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1422F, -4.0802F, 20.25F, 0.0F, 0.0F, -0.0873F));
		...
		.texOffs(158, 0).addBox(-19.988F, -1.9058F, -32.0509F, 10.0F, 2.0F, 32.0F, new CubeDeformation(0.0F)), PartPose.offset(-7.4186F, -3.1496F, -14.7587F));

		PartDefinition cube_r75 = hood.addOrReplaceChild("cube_r75", CubeListBuilder.create().texOffs(108, 218).mirror().addBox(9.988F, -14.0463F, -31.8869F, 10.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(108, 218).addBox(-19.012F, -14.0463F, -31.8869F, 10.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.976F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r76 = hood.addOrReplaceChild("cube_r76", CubeListBuilder.create().texOffs(139, 100).addBox(0.5F, -1.0F, -7.5F, 1.0F, 1.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.488F, 8.0942F, -20.5509F, 1.7453F, 0.0F, 0.0F));

		PartDefinition bodykits = body.addOrReplaceChild("bodykits", CubeListBuilder.create(), PartPose.offset(-4.9066F, -1.0554F, 2.1904F));

		PartDefinition cobraii = bodykits.addOrReplaceChild("cobraii", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition spoiler_r1 = cobraii.addOrReplaceChild("spoiler_r1", CubeListBuilder.create().texOffs(196, 158).addBox(-19.25F, -5.0F, -1.0F, 39.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.25F, -3.9947F, 47.1649F, -0.5236F, 0.0F, 0.0F));

		PartDefinition cobraii_hood = cobraii.addOrReplaceChild("cobraii_hood", CubeListBuilder.create().texOffs(142, 184).addBox(-6.988F, -3.9058F, -16.3509F, 13.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.512F, -2.0942F, -16.9491F));

		PartDefinition cube_r77 = cobraii_hood.addOrReplaceChild("cube_r77", CubeListBuilder.create().texOffs(260, 34).addBox(8.012F, 6.0942F, -27.0509F, 13.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-15.0F, 0.85F, 12.0F, -0.3927F, 0.0F, 0.0F));
