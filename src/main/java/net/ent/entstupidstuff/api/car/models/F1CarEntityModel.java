...
public class F1CarEntityModel extends BaseCarEntityModel {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r15 = updated_body.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(190, 278).addBox(2.0F, 1.0F, 0.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(278, 121).addBox(-3.0F, 1.0F, 0.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -22.9F, 14.4F, -0.4276F, 0.0F, 0.0F));
		...
		PartDefinition cube_r74 = updated_body.addOrReplaceChild("cube_r74", CubeListBuilder.create().texOffs(288, 110).addBox(1.5F, 0.0187F, -2.4921F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(288, 108).addBox(1.6F, 0.0187F, -1.4921F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(288, 106).addBox(1.8F, 0.0187F, -0.4921F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r83 = updated_body.addOrReplaceChild("cube_r83", CubeListBuilder.create().texOffs(250, 100).addBox(-1.9758F, 0.0F, -4.007F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.55F, -12.0F, -36.5F, 0.1745F, 0.1222F, 0.0F));
		...
		PartDefinition cube_r85 = updated_body.addOrReplaceChild("cube_r85", CubeListBuilder.create().texOffs(26, 265).addBox(-0.8546F, -1.0F, -6.1384F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.55F, -13.0F, -27.3F, 0.1396F, 0.1222F, 0.0F));
		...
		.texOffs(102, 288).addBox(-2.5F, 0.0187F, -2.4921F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(98, 288).addBox(-2.6F, 0.0187F, -1.4921F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(288, 20).addBox(-2.8F, 0.0187F, -0.4921F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(226, 257).addBox(0.0F, 4.5F, 1.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r133 = updated_body.addOrReplaceChild("cube_r133", CubeListBuilder.create().texOffs(66, 216).addBox(-4.0F, -0.0164F, 0.0494F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(260, 237).addBox(-5.0F, -0.0164F, 4.0494F, 5.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, -9.5F, -52.6F, 0.017F, 0.3137F, -1.5157F));
		...
		PartDefinition cube_r139 = updated_body.addOrReplaceChild("cube_r139", CubeListBuilder.create().texOffs(42, 267).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, -58.0F, 0.4363F, 0.0F, 0.0F));
		...
		PartDefinition cube_r146 = updated_body.addOrReplaceChild("cube_r146", CubeListBuilder.create().texOffs(278, 14).addBox(-1.9343F, 0.0F, -0.0489F, 2.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.15F, -14.0F, -16.85F, 0.0F, 0.5498F, 0.0F));

		PartDefinition cube_r147 = updated_body.addOrReplaceChild("cube_r147", CubeListBuilder.create().texOffs(276, 274).addBox(-0.0657F, 0.0F, -0.0489F, 2.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.15F, -14.0F, -16.85F, 0.0F, -0.5498F, 0.0F));

		PartDefinition cube_r148 = updated_body.addOrReplaceChild("cube_r148", CubeListBuilder.create().texOffs(80, 246).addBox(-0.9802F, 0.01F, 4.0024F, 3.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(214, 50).addBox(-1.9802F, 0.0F, 3.0024F, 2.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.75F, -14.0F, -17.2F, 0.0F, 0.3316F, 0.0F));

		PartDefinition cube_r149 = updated_body.addOrReplaceChild("cube_r149", CubeListBuilder.create().texOffs(60, 246).addBox(-2.0198F, 0.01F, 4.0024F, 3.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(108, 215).addBox(-0.0198F, 0.0F, 3.0024F, 2.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.75F, -14.0F, -17.2F, 0.0F, -0.3316F, 0.0F));
		...
		PartDefinition cube_r158 = updated_body.addOrReplaceChild("cube_r158", CubeListBuilder.create().texOffs(88, 278).addBox(0.0001F, 0.0F, -0.0099F, 1.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-12.7F, -8.0F, -11.35F, 0.6088F, -0.4202F, -1.0414F));

		PartDefinition cube_r159 = updated_body.addOrReplaceChild("cube_r159", CubeListBuilder.create().texOffs(0, 186).addBox(0.0001F, 0.0F, -10.0099F, 1.0F, 4.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-12.2F, -7.6F, -9.25F, -0.3104F, -0.6978F, 0.3695F));

		PartDefinition cube_r160 = updated_body.addOrReplaceChild("cube_r160", CubeListBuilder.create().texOffs(122, 202).addBox(0.0001F, 0.0F, -9.0099F, 1.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-12.7F, -8.0F, -11.35F, 0.8467F, -0.5453F, -1.1408F));

		PartDefinition cube_r161 = updated_body.addOrReplaceChild("cube_r161", CubeListBuilder.create().texOffs(88, 212).addBox(0.0001F, 0.0F, -9.0099F, 1.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-13.3F, -9.0F, -11.95F, 0.7622F, -0.6713F, -0.9933F));

		PartDefinition cube_r162 = updated_body.addOrReplaceChild("cube_r162", CubeListBuilder.create().texOffs(176, 282).addBox(0.0001F, 0.0F, -0.0099F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-13.3F, -9.0F, -11.95F, 0.5171F, -0.5324F, -0.8421F));

		PartDefinition cube_r163 = updated_body.addOrReplaceChild("cube_r163", CubeListBuilder.create().texOffs(260, 132).addBox(0.0001F, 0.0F, -0.0099F, 6.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r164 = updated_body.addOrReplaceChild("cube_r164", CubeListBuilder.create().texOffs(24, 197).addBox(0.0F, 0.0F, -8.0F, 2.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.8F, -9.0F, 28.0F, -0.2808F, 0.5896F, -0.4785F));

		PartDefinition cube_r165 = updated_body.addOrReplaceChild("cube_r165", CubeListBuilder.create().texOffs(88, 83).addBox(0.0F, 0.0F, -10.0F, 2.0F, 9.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.8F, -13.0F, 28.0F, 0.0F, 0.3578F, 0.0F));

		PartDefinition cube_r166 = updated_body.addOrReplaceChild("cube_r166", CubeListBuilder.create().texOffs(80, 190).addBox(0.0F, 0.0F, -8.0F, 2.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.8F, -13.0F, 28.0F, 0.0F, 0.6458F, 0.0F));

		PartDefinition cube_r167 = updated_body.addOrReplaceChild("cube_r167", CubeListBuilder.create().texOffs(260, 195).addBox(-0.0182F, 0.0F, -5.0F, 2.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-10.6F, -9.0F, 21.6F, -0.2347F, 0.5116F, -0.4544F));

		PartDefinition cube_r168 = updated_body.addOrReplaceChild("cube_r168", CubeListBuilder.create().texOffs(88, 203).addBox(-0.0182F, 0.0F, -5.0F, 2.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-10.6F, -13.0F, 21.6F, 0.0F, 0.5585F, 0.0F));

		PartDefinition cube_r169 = updated_body.addOrReplaceChild("cube_r169", CubeListBuilder.create().texOffs(272, 43).addBox(-0.0182F, 0.0F, -4.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-13.25F, -9.0F, 17.4F, -0.1459F, 0.3375F, -0.4176F));

		PartDefinition cube_r170 = updated_body.addOrReplaceChild("cube_r170", CubeListBuilder.create().texOffs(274, 34).addBox(-0.0182F, 0.0F, -4.0F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-13.25F, -13.0F, 17.4F, 0.0F, 0.3665F, 0.0F));

		PartDefinition cube_r171 = updated_body.addOrReplaceChild("cube_r171", CubeListBuilder.create().texOffs(242, 241).addBox(-0.0031F, 0.0F, -0.011F, 2.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.35F, -9.0F, 7.9F, -0.1093F, 0.2575F, -0.4069F));

		PartDefinition cube_r172 = updated_body.addOrReplaceChild("cube_r172", CubeListBuilder.create().texOffs(252, 22).addBox(-0.0031F, 0.0F, -0.011F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.35F, -13.0F, 7.9F, 0.0F, 0.2793F, 0.0F));

		PartDefinition cube_r173 = updated_body.addOrReplaceChild("cube_r173", CubeListBuilder.create().texOffs(150, 186).addBox(0.0F, 0.0F, -11.0F, 1.0F, 3.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-14.5F, -6.0F, 2.0F, -0.068F, -0.122F, 0.2311F));

		PartDefinition cube_r174 = updated_body.addOrReplaceChild("cube_r174", CubeListBuilder.create().texOffs(72, 121).addBox(0.0F, 0.0F, -11.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r175 = updated_body.addOrReplaceChild("cube_r175", CubeListBuilder.create().texOffs(124, 173).addBox(0.0F, 0.0F, -11.0F, 2.0F, 4.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-17.5F, -13.0F, 2.0F, 0.0F, -0.1396F, 0.0F));

		PartDefinition cube_r176 = updated_body.addOrReplaceChild("cube_r176", CubeListBuilder.create().texOffs(58, 264).addBox(0.0F, 0.0F, 0.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-15.9F, -5.3F, 1.7F, -0.1124F, 0.156F, -0.6284F));

		PartDefinition cube_r177 = updated_body.addOrReplaceChild("cube_r177", CubeListBuilder.create().texOffs(76, 254).addBox(0.0F, 0.0F, 0.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-17.5F, -9.0F, 2.0F, -0.0742F, 0.1772F, -0.3993F));

		PartDefinition cube_r178 = updated_body.addOrReplaceChild("cube_r178", CubeListBuilder.create().texOffs(60, 254).addBox(0.0F, 0.0F, 0.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-17.5F, -13.0F, 2.0F, 0.0F, 0.192F, 0.0F));

		PartDefinition cube_r179 = updated_body.addOrReplaceChild("cube_r179", CubeListBuilder.create().texOffs(284, 222).addBox(0.0F, -1.0F, 0.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.5F, -9.0F, 2.0F, 0.4006F, 0.1933F, 0.0812F));

		PartDefinition cube_r180 = updated_body.addOrReplaceChild("cube_r180", CubeListBuilder.create().texOffs(142, 208).addBox(0.0F, 0.0F, -8.0F, 2.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.8F, -14.0F, 28.0F, 0.0F, 0.6458F, 0.0F));

		PartDefinition cube_r181 = updated_body.addOrReplaceChild("cube_r181", CubeListBuilder.create().texOffs(140, 280).addBox(1.9818F, 0.0F, -4.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r182 = updated_body.addOrReplaceChild("cube_r182", CubeListBuilder.create().texOffs(250, 273).addBox(1.9818F, 0.0F, -5.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r183 = updated_body.addOrReplaceChild("cube_r183", CubeListBuilder.create().texOffs(260, 125).addBox(2.0F, 0.0F, 0.0F, 3.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r184 = updated_body.addOrReplaceChild("cube_r184", CubeListBuilder.create().texOffs(260, 80).addBox(1.9969F, 0.0F, -0.011F, 3.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r185 = updated_body.addOrReplaceChild("cube_r185", CubeListBuilder.create().texOffs(0, 249).addBox(0.0067F, -7.0F, -0.9873F, 2.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.65F, -7.0F, -19.65F, 0.0F, -0.2094F, 0.0F));

		PartDefinition cube_r186 = updated_body.addOrReplaceChild("cube_r186", CubeListBuilder.create().texOffs(98, 282).addBox(-0.2296F, 0.0F, -2.9956F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.1F, -10.0F, -45.5F, 0.3927F, -0.0349F, 0.0F));

		PartDefinition cube_r187 = updated_body.addOrReplaceChild("cube_r187", CubeListBuilder.create().texOffs(0, 216).addBox(-0.0202F, -4.0F, 6.0008F, 2.0F, 5.0F, 7.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r188 = updated_body.addOrReplaceChild("cube_r188", CubeListBuilder.create().texOffs(270, 282).addBox(0.0062F, -1.0F, 0.0318F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.6F, -7.0F, -55.5F, -0.0503F, -0.1209F, 0.3957F));

		PartDefinition cube_r189 = updated_body.addOrReplaceChild("cube_r189", CubeListBuilder.create().texOffs(114, 280).addBox(0.0062F, 0.0F, 0.0318F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.6F, -7.0F, -55.5F, 0.0F, -0.1309F, 0.0F));

		PartDefinition cube_r190 = updated_body.addOrReplaceChild("cube_r190", CubeListBuilder.create().texOffs(44, 197).addBox(0.0F, -1.0F, 1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, -7.0F, -58.0F, -0.4233F, -0.3897F, 0.8702F));

		PartDefinition cube_r191 = updated_body.addOrReplaceChild("cube_r191", CubeListBuilder.create().texOffs(284, 218).addBox(0.0F, 0.0F, 0.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, -7.0F, -58.0F, 0.0F, -0.5672F, 0.0F));

		PartDefinition cube_r192 = updated_body.addOrReplaceChild("cube_r192", CubeListBuilder.create().texOffs(264, 259).addBox(-1.1454F, -1.0F, -6.1384F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.55F, -13.0F, -27.3F, 0.1396F, -0.1222F, 0.0F));

		PartDefinition cube_r193 = updated_body.addOrReplaceChild("cube_r193", CubeListBuilder.create().texOffs(26, 124).addBox(-0.0242F, -5.0F, 2.993F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r194 = updated_body.addOrReplaceChild("cube_r194", CubeListBuilder.create().texOffs(0, 201).addBox(-1.719F, -8.0F, -6.356F, 2.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5258F, -4.3F, -17.0886F, -0.299F, -0.1722F, 0.0155F));

		PartDefinition cube_r195 = updated_body.addOrReplaceChild("cube_r195", CubeListBuilder.create().texOffs(218, 248).addBox(-0.0242F, 0.0F, -4.007F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.55F, -12.0F, -36.5F, 0.1745F, -0.1222F, 0.0F));

		PartDefinition cube_r196 = updated_body.addOrReplaceChild("cube_r196", CubeListBuilder.create().texOffs(280, 68).addBox(-2.0062F, 0.0F, 0.0318F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.6F, -7.0F, -55.5F, 0.0F, 0.1309F, 0.0F));

		PartDefinition cube_r197 = updated_body.addOrReplaceChild("cube_r197", CubeListBuilder.create().texOffs(284, 186).addBox(-2.0F, 0.0F, 0.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -7.0F, -58.0F, 0.0F, 0.5672F, 0.0F));

		PartDefinition cube_r198 = updated_body.addOrReplaceChild("cube_r198", CubeListBuilder.create().texOffs(286, 63).addBox(0.0F, 5.7101F, 0.6985F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r199 = updated_body.addOrReplaceChild("cube_r199", CubeListBuilder.create().texOffs(48, 286).addBox(-1.0F, -0.5F, -4.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r200 = updated_body.addOrReplaceChild("cube_r200", CubeListBuilder.create().texOffs(238, 0).addBox(0.0F, 0.0F, -1.0F, 1.0F, 2.25F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r201 = updated_body.addOrReplaceChild("cube_r201", CubeListBuilder.create().texOffs(82, 279).addBox(0.0F, -0.2141F, -1.98F, 1.0F, 3.25F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r202 = updated_body.addOrReplaceChild("cube_r202", CubeListBuilder.create().texOffs(250, 286).addBox(0.0F, 0.01F, -2.002F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r203 = updated_body.addOrReplaceChild("cube_r203", CubeListBuilder.create().texOffs(196, 284).addBox(0.0F, 0.01F, -2.002F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r204 = updated_body.addOrReplaceChild("cube_r204", CubeListBuilder.create().texOffs(252, 253).addBox(-3.9988F, 0.6F, 0.0166F, 4.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.05F, -6.5F, -52.3F, 0.0F, -0.2182F, 0.0349F));

		PartDefinition cube_r205 = updated_body.addOrReplaceChild("cube_r205", CubeListBuilder.create().texOffs(210, 125).addBox(-0.0249F, 0.5F, 0.0254F, 8.0F, 0.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r206 = updated_body.addOrReplaceChild("cube_r206", CubeListBuilder.create().texOffs(234, 222).addBox(0.0F, 0.5F, 0.0F, 5.0F, 0.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r207 = updated_body.addOrReplaceChild("cube_r207", CubeListBuilder.create().texOffs(252, 174).addBox(-0.0012F, 0.6F, 0.0166F, 4.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.05F, -6.5F, -52.3F, 0.0F, 0.2182F, -0.0349F));

		PartDefinition cube_r208 = updated_body.addOrReplaceChild("cube_r208", CubeListBuilder.create().texOffs(178, 0).addBox(-2.0249F, 0.6F, 0.0254F, 11.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, -6.5F, -51.75F, 0.01F, -0.2791F, -0.0014F));

		PartDefinition cube_r209 = updated_body.addOrReplaceChild("cube_r209", CubeListBuilder.create().texOffs(174, 165).addBox(-8.9751F, 0.6F, 0.0254F, 11.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.0F, -6.5F, -51.75F, 0.01F, 0.2791F, 0.0014F));

		PartDefinition cube_r210 = updated_body.addOrReplaceChild("cube_r210", CubeListBuilder.create().texOffs(286, 38).addBox(-0.0012F, 0.0F, 0.0166F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.05F, -6.0F, -52.3F, 0.0F, 0.2182F, 0.0F));

		PartDefinition cube_r211 = updated_body.addOrReplaceChild("cube_r211", CubeListBuilder.create().texOffs(286, 276).addBox(-0.0181F, 0.0F, -0.0642F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.3F, -7.0F, -48.75F, 0.0F, 0.3665F, 0.0F));

		PartDefinition cube_r212 = updated_body.addOrReplaceChild("cube_r212", CubeListBuilder.create().texOffs(216, 89).addBox(-5.9801F, 0.0F, -0.9578F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.9F, -7.0F, -47.95F, 0.0F, 0.5061F, 0.0F));

		PartDefinition cube_r213 = updated_body.addOrReplaceChild("cube_r213", CubeListBuilder.create().texOffs(286, 36).addBox(0.0F, 0.0F, -1.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-14.0F, -7.0F, -44.05F, 0.0F, 0.2443F, 0.0F));

		PartDefinition cube_r214 = updated_body.addOrReplaceChild("cube_r214", CubeListBuilder.create().texOffs(256, 218).addBox(-7.9751F, 0.0F, 0.0254F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.0F, -6.0F, -51.75F, 0.0F, 0.2793F, 0.0F));

		PartDefinition cube_r215 = updated_body.addOrReplaceChild("cube_r215", CubeListBuilder.create().texOffs(0, 167).addBox(-5.0F, 0.5F, 0.0F, 5.0F, 0.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r216 = updated_body.addOrReplaceChild("cube_r216", CubeListBuilder.create().texOffs(208, 186).addBox(-7.9751F, 0.5F, 0.0254F, 8.0F, 0.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r217 = updated_body.addOrReplaceChild("cube_r217", CubeListBuilder.create().texOffs(286, 34).addBox(0.0F, -1.0F, -7.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -4.0F, -48.25F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r218 = updated_body.addOrReplaceChild("cube_r218", CubeListBuilder.create().texOffs(282, 153).addBox(-3.9988F, 0.0F, 0.0166F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.05F, -6.0F, -52.3F, 0.0F, -0.2182F, 0.0F));

		PartDefinition cube_r219 = updated_body.addOrReplaceChild("cube_r219", CubeListBuilder.create().texOffs(256, 98).addBox(-2.0249F, 0.0F, 0.0254F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, -6.0F, -51.75F, 0.0F, -0.2793F, 0.0F));

		PartDefinition cube_r220 = updated_body.addOrReplaceChild("cube_r220", CubeListBuilder.create().texOffs(216, 137).addBox(-4.0F, -1.0F, -7.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -4.0F, -48.25F, 0.0F, 0.0F, 0.3927F));

		PartDefinition cube_r221 = updated_body.addOrReplaceChild("cube_r221", CubeListBuilder.create().texOffs(98, 124).addBox(-3.0F, 0.0F, -2.5F, 6.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.4F, -53.75F, 0.1571F, 0.0F, 0.0F));

		PartDefinition cube_r222 = updated_body.addOrReplaceChild("cube_r222", CubeListBuilder.create().texOffs(276, 247).addBox(-2.9819F, 0.0F, -0.0642F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.3F, -7.0F, -48.75F, 0.0F, -0.3665F, 0.0F));

		PartDefinition cube_r223 = updated_body.addOrReplaceChild("cube_r223", CubeListBuilder.create().texOffs(108, 50).addBox(-0.02F, 0.0F, -0.9578F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.9F, -7.0F, -47.95F, 0.0F, -0.5061F, 0.0F));

		PartDefinition cube_r224 = updated_body.addOrReplaceChild("cube_r224", CubeListBuilder.create().texOffs(78, 105).addBox(-4.0F, 0.0F, -1.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(14.0F, -7.0F, -44.05F, 0.0F, -0.2443F, 0.0F));

		PartDefinition cube_r225 = updated_body.addOrReplaceChild("cube_r225", CubeListBuilder.create().texOffs(68, 200).addBox(0.0F, -1.5F, -2.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r226 = updated_body.addOrReplaceChild("cube_r226", CubeListBuilder.create().texOffs(256, 96).addBox(0.0F, 0.0F, 0.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -11.0F, -37.0F, 0.0F, -0.1222F, 0.0F));

		PartDefinition cube_r227 = updated_body.addOrReplaceChild("cube_r227", CubeListBuilder.create().texOffs(230, 98).addBox(-2.0F, 0.0F, 0.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, -7.8F, -37.0F, 0.0389F, -0.1158F, -0.3251F));

		PartDefinition cube_r228 = updated_body.addOrReplaceChild("cube_r228", CubeListBuilder.create().texOffs(282, 78).addBox(0.0165F, 0.0F, -1.005F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.45F, -9.0F, -31.0F, 0.0F, 0.4712F, 0.0F));

		PartDefinition cube_r229 = updated_body.addOrReplaceChild("cube_r229", CubeListBuilder.create().texOffs(192, 79).addBox(-13.1692F, 0.0F, -0.7664F, 13.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(14.0F, -11.0F, -35.0F, -0.1846F, 0.5187F, -0.2898F));

		PartDefinition cube_r230 = updated_body.addOrReplaceChild("cube_r230", CubeListBuilder.create().texOffs(236, 163).addBox(-1.0F, 0.0F, -1.0F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.2F, -9.0F, -27.2F, 0.0F, 0.733F, 0.0F));

		PartDefinition cube_r231 = updated_body.addOrReplaceChild("cube_r231", CubeListBuilder.create().texOffs(128, 40).addBox(0.1692F, 0.0F, -0.7664F, 13.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-14.0F, -11.0F, -35.0F, -0.1846F, -0.5187F, 0.2898F));

		PartDefinition cube_r232 = updated_body.addOrReplaceChild("cube_r232", CubeListBuilder.create().texOffs(230, 96).addBox(-10.0F, 0.0F, 0.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, -7.8F, -37.0F, 0.0389F, 0.1158F, 0.3251F));

		PartDefinition cube_r233 = updated_body.addOrReplaceChild("cube_r233", CubeListBuilder.create().texOffs(128, 38).addBox(-10.0F, 0.0F, 0.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -11.0F, -37.0F, 0.0F, 0.1222F, 0.0F));

		PartDefinition cube_r234 = updated_body.addOrReplaceChild("cube_r234", CubeListBuilder.create().texOffs(282, 12).addBox(-5.0165F, 0.0F, -1.005F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.45F, -9.0F, -31.0F, 0.0F, -0.4712F, 0.0F));

		PartDefinition cube_r235 = updated_body.addOrReplaceChild("cube_r235", CubeListBuilder.create().texOffs(172, 231).addBox(-6.0F, 0.0F, -1.0F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.2F, -9.0F, -27.2F, 0.0F, -0.733F, 0.0F));

		PartDefinition cube_r236 = updated_body.addOrReplaceChild("cube_r236", CubeListBuilder.create().texOffs(70, 279).addBox(0.0F, 0.0F, -4.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(248, 137).addBox(2.0F, 0.01F, -6.0F, 4.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(258, 249).addBox(3.0F, 0.0F, -7.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.5F, -14.0F, -5.0F, 0.0F, -0.1309F, 0.0F));

		PartDefinition cube_r237 = updated_body.addOrReplaceChild("cube_r237", CubeListBuilder.create().texOffs(22, 248).addBox(-6.0F, 0.01F, -6.0F, 4.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(234, 187).addBox(-6.0F, 0.0F, -7.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r238 = updated_body.addOrReplaceChild("cube_r238", CubeListBuilder.create().texOffs(12, 279).addBox(0.0F, 0.0F, -4.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.5F, -10.0F, -5.0F, 0.0F, -0.1309F, 0.0F));

		PartDefinition cube_r239 = updated_body.addOrReplaceChild("cube_r239", CubeListBuilder.create().texOffs(18, 221).addBox(0.0F, 0.0F, -4.0F, 7.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.5F, -13.0F, -5.0F, 0.0F, -0.1309F, 0.0F));

		PartDefinition cube_r240 = updated_body.addOrReplaceChild("cube_r240", CubeListBuilder.create().texOffs(212, 220).addBox(-7.0F, 0.0F, -4.0F, 7.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(16.5F, -13.0F, -5.0F, 0.0F, 0.1309F, 0.0F));

		PartDefinition cube_r241 = updated_body.addOrReplaceChild("cube_r241", CubeListBuilder.create().texOffs(210, 278).addBox(-2.0F, 0.0F, -4.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(16.5F, -10.0F, -5.0F, 0.0F, 0.1309F, 0.0F));

		PartDefinition cube_r242 = updated_body.addOrReplaceChild("cube_r242", CubeListBuilder.create().texOffs(252, 88).addBox(-1.9969F, -0.01F, -0.011F, 2.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.1F, -14.0F, 7.95F, 0.0F, -0.2094F, 0.0F));

		PartDefinition cube_r243 = updated_body.addOrReplaceChild("cube_r243", CubeListBuilder.create().texOffs(258, 117).addBox(-1.9969F, -0.01F, -0.011F, 2.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.65F, -14.0F, 14.8F, 0.0F, -0.2793F, 0.0F));

		PartDefinition cube_r244 = updated_body.addOrReplaceChild("cube_r244", CubeListBuilder.create().texOffs(212, 0).addBox(-11.0F, 0.0F, 0.0F, 11.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(12.5F, -11.0F, 35.5F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r245 = updated_body.addOrReplaceChild("cube_r245", CubeListBuilder.create().texOffs(0, 273).addBox(0.0017F, 0.0F, -4.0075F, 2.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-10.85F, -14.0F, -3.95F, 0.0F, -0.2182F, 0.0F));

		PartDefinition cube_r246 = updated_body.addOrReplaceChild("cube_r246", CubeListBuilder.create().texOffs(272, 249).addBox(-2.0017F, 0.0F, -4.0075F, 2.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(10.85F, -14.0F, -3.95F, 0.0F, 0.2182F, 0.0F));

		PartDefinition cube_r247 = updated_body.addOrReplaceChild("cube_r247", CubeListBuilder.create().texOffs(222, 156).addBox(-2.0F, -0.01F, -5.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.5F, -14.0F, 1.0F, 0.0F, 0.1309F, 0.0F));

		PartDefinition cube_r248 = updated_body.addOrReplaceChild("cube_r248", CubeListBuilder.create().texOffs(278, 127).addBox(-2.0F, -0.01F, 0.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.5F, -14.0F, 4.0F, 0.0F, -0.1047F, 0.0F));

		PartDefinition cube_r249 = updated_body.addOrReplaceChild("cube_r249", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, 1.0F, -25.0F, 10.0F, 1.0F, 25.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-15.8F, -5.0F, 24.0F, 0.0F, 0.0349F, 0.0F));

		PartDefinition cube_r250 = updated_body.addOrReplaceChild("cube_r250", CubeListBuilder.create().texOffs(268, 187).addBox(0.0F, -0.0353F, -4.9913F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.8F, -6.9494F, 30.7639F, 0.5458F, 0.7419F, 0.3894F));
		...
		PartDefinition cube_r251 = Front_Left_Wheel.addOrReplaceChild("cube_r251", CubeListBuilder.create().texOffs(94, 286).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, 1.3F, 3.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r252 = Front_Left_Wheel.addOrReplaceChild("cube_r252", CubeListBuilder.create().texOffs(222, 278).addBox(-0.5F, -1.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, 3.35F, 1.39F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r253 = Front_Left_Wheel.addOrReplaceChild("cube_r253", CubeListBuilder.create().texOffs(152, 280).addBox(-0.5F, -2.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, -1.7F, -3.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r254 = Front_Left_Wheel.addOrReplaceChild("cube_r254", CubeListBuilder.create().texOffs(48, 283).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, 1.3F, -3.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r255 = Front_Left_Wheel.addOrReplaceChild("cube_r255", CubeListBuilder.create().texOffs(270, 193).addBox(-0.5F, -1.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, 3.35F, -1.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r256 = Front_Left_Wheel.addOrReplaceChild("cube_r256", CubeListBuilder.create().texOffs(88, 270).addBox(-0.5F, 0.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, -3.75F, -1.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r257 = Front_Left_Wheel.addOrReplaceChild("cube_r257", CubeListBuilder.create().texOffs(230, 184).addBox(-0.5F, 0.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, -3.75F, 1.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r258 = Front_Left_Wheel.addOrReplaceChild("cube_r258", CubeListBuilder.create().texOffs(48, 280).addBox(-0.5F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, -1.7F, 3.39F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r259 = Front_Right_Wheel.addOrReplaceChild("cube_r259", CubeListBuilder.create().texOffs(174, 171).addBox(-0.5F, -1.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.5F, 3.35F, 1.39F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r260 = Front_Right_Wheel.addOrReplaceChild("cube_r260", CubeListBuilder.create().texOffs(178, 13).addBox(-0.5F, -1.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.5F, 3.35F, -1.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r261 = Front_Right_Wheel.addOrReplaceChild("cube_r261", CubeListBuilder.create().texOffs(70, 275).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.5F, 1.3F, -3.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r262 = Front_Right_Wheel.addOrReplaceChild("cube_r262", CubeListBuilder.create().texOffs(70, 272).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.5F, 1.3F, 3.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r263 = Front_Right_Wheel.addOrReplaceChild("cube_r263", CubeListBuilder.create().texOffs(156, 40).addBox(-0.5F, 0.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.5F, -3.75F, 1.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r264 = Front_Right_Wheel.addOrReplaceChild("cube_r264", CubeListBuilder.create().texOffs(268, 170).addBox(-0.5F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.5F, -1.7F, 3.39F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r265 = Front_Right_Wheel.addOrReplaceChild("cube_r265", CubeListBuilder.create().texOffs(22, 152).addBox(-0.5F, 0.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.5F, -3.75F, -1.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r266 = Front_Right_Wheel.addOrReplaceChild("cube_r266", CubeListBuilder.create().texOffs(254, 54).addBox(-0.5F, -2.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.5F, -1.7F, -3.61F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r267 = Back_Left_Wheel.addOrReplaceChild("cube_r267", CubeListBuilder.create().texOffs(94, 286).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, 1.3F, 3.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r268 = Back_Left_Wheel.addOrReplaceChild("cube_r268", CubeListBuilder.create().texOffs(222, 278).addBox(-0.5F, -1.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, 3.35F, 1.39F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r269 = Back_Left_Wheel.addOrReplaceChild("cube_r269", CubeListBuilder.create().texOffs(152, 280).addBox(-0.5F, -2.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, -1.7F, -3.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r270 = Back_Left_Wheel.addOrReplaceChild("cube_r270", CubeListBuilder.create().texOffs(48, 283).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, 1.3F, -3.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r271 = Back_Left_Wheel.addOrReplaceChild("cube_r271", CubeListBuilder.create().texOffs(270, 193).addBox(-0.5F, -1.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, 3.35F, -1.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r272 = Back_Left_Wheel.addOrReplaceChild("cube_r272", CubeListBuilder.create().texOffs(88, 270).addBox(-0.5F, 0.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, -3.75F, -1.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r273 = Back_Left_Wheel.addOrReplaceChild("cube_r273", CubeListBuilder.create().texOffs(230, 184).addBox(-0.5F, 0.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, -3.75F, 1.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r274 = Back_Left_Wheel.addOrReplaceChild("cube_r274", CubeListBuilder.create().texOffs(48, 280).addBox(-0.5F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, -1.7F, 3.39F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r275 = Back_Right_Wheel.addOrReplaceChild("cube_r275", CubeListBuilder.create().texOffs(94, 286).mirror().addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.5F, 1.3F, 3.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r276 = Back_Right_Wheel.addOrReplaceChild("cube_r276", CubeListBuilder.create().texOffs(222, 278).mirror().addBox(-0.5F, -1.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.5F, 3.35F, 1.39F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r277 = Back_Right_Wheel.addOrReplaceChild("cube_r277", CubeListBuilder.create().texOffs(152, 280).mirror().addBox(-0.5F, -2.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.5F, -1.7F, -3.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r278 = Back_Right_Wheel.addOrReplaceChild("cube_r278", CubeListBuilder.create().texOffs(48, 283).mirror().addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.5F, 1.3F, -3.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r279 = Back_Right_Wheel.addOrReplaceChild("cube_r279", CubeListBuilder.create().texOffs(270, 193).mirror().addBox(-0.5F, -1.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.5F, 3.35F, -1.61F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r280 = Back_Right_Wheel.addOrReplaceChild("cube_r280", CubeListBuilder.create().texOffs(88, 270).mirror().addBox(-0.5F, 0.05F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.5F, -3.75F, -1.61F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r281 = Back_Right_Wheel.addOrReplaceChild("cube_r281", CubeListBuilder.create().texOffs(230, 184).mirror().addBox(-0.5F, 0.05F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.5F, -3.75F, 1.39F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r282 = Back_Right_Wheel.addOrReplaceChild("cube_r282", CubeListBuilder.create().texOffs(48, 280).mirror().addBox(-0.5F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.5F, -1.7F, 3.39F, 0.7854F, 0.0F, 0.0F));
