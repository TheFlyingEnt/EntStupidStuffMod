...
public class DMC13Model extends BaseCarEntityModel<BaseCarRenderState> {
	...
	public DMC13Model(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 196).addBox(16.7008F, -8.2349F, -20.854F, 2.0F, 1.0F, 39.0F, new CubeDeformation(0.0F))
		.texOffs(0, 196).mirror().addBox(-19.2992F, -8.2349F, -20.854F, 2.0F, 1.0F, 39.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(52, 243).addBox(16.7008F, -16.2349F, -1.854F, 2.0F, 2.0F, 22.0F, new CubeDeformation(0.0F))
		.texOffs(0, 172).addBox(-17.2992F, -16.2349F, -1.854F, 34.0F, 2.0F, 22.0F, new CubeDeformation(0.0F))
		.texOffs(52, 243).mirror().addBox(-19.2992F, -16.2349F, -1.854F, 2.0F, 2.0F, 22.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(210, 185).addBox(-22.2992F, -3.2349F, 47.146F, 44.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(112, 172).addBox(16.7008F, -15.2349F, 16.146F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(148, 270).addBox(17.7008F, -14.2349F, 16.146F, 0.0F, 7.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(148, 270).mirror().addBox(-18.2992F, -14.2349F, 16.146F, 0.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(212, 245).addBox(16.7008F, -9.1349F, 18.146F, 2.0F, 1.0F, 19.0F, new CubeDeformation(0.0F))
		.texOffs(212, 245).mirror().addBox(-19.2992F, -9.1349F, 18.146F, 2.0F, 1.0F, 19.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(112, 172).mirror().addBox(-19.2992F, -15.2349F, 16.146F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(0, 103).addBox(-18.2992F, -8.2349F, 22.146F, 35.0F, 1.0F, 24.0F, new CubeDeformation(0.0F))
		.texOffs(104, 128).addBox(17.3508F, -0.2349F, 18.896F, 5.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(240, 265).addBox(17.3508F, -5.2349F, 23.896F, 5.0F, 2.0F, 10.0F, new CubeDeformation(0.0F))
		.texOffs(104, 128).addBox(17.3508F, -0.2349F, 36.896F, 5.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(104, 128).addBox(17.3508F, -0.2349F, -44.104F, 5.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(240, 265).addBox(17.3508F, -5.2349F, -39.104F, 5.0F, 2.0F, 10.0F, new CubeDeformation(0.0F))
		.texOffs(104, 128).addBox(17.3508F, -0.2349F, -26.104F, 5.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		...
		.texOffs(126, 264).addBox(16.7008F, -16.2349F, 20.146F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(126, 264).mirror().addBox(-19.2992F, -16.2349F, 20.146F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(228, 229).addBox(-17.2992F, -16.2349F, 20.146F, 34.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(228, 242).addBox(-17.2992F, -14.2349F, 29.146F, 34.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(228, 242).addBox(-17.2992F, -15.2349F, 26.146F, 34.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 138).addBox(-19.7992F, -7.2349F, -30.254F, 39.0F, 2.0F, 10.0F, new CubeDeformation(0.0F))
		.texOffs(228, 242).addBox(-17.2992F, -13.2349F, 32.146F, 34.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(210, 194).addBox(-18.2992F, -11.2349F, 43.146F, 36.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(214, 101).addBox(-18.1991F, -11.2349F, 37.146F, 36.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(214, 121).addBox(-20.2992F, -10.2349F, 46.146F, 40.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(82, 201).addBox(-4.2992F, 0.5151F, -22.854F, 7.0F, 6.0F, 30.0F, new CubeDeformation(0.0F))
		.texOffs(210, 188).addBox(-20.2992F, -5.2349F, -50.854F, 39.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-20.2992F, 5.7651F, -25.854F, 38.0F, 1.0F, 45.0F, new CubeDeformation(0.0F))
		.texOffs(214, 110).addBox(-20.2992F, -2.2349F, -25.854F, 38.0F, 8.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(270, 265).addBox(19.4008F, -1.2349F, -52.854F, 3.0F, 4.0F, 9.0F, new CubeDeformation(0.0F))
		.texOffs(166, 0).addBox(19.2008F, -1.2349F, -24.854F, 3.0F, 2.0F, 44.0F, new CubeDeformation(0.0F))
		.texOffs(28, 267).addBox(18.8009F, -3.2349F, 36.146F, 3.0F, 2.0F, 11.0F, new CubeDeformation(0.0F))
		.texOffs(28, 267).mirror().addBox(-22.3992F, -3.2349F, 36.146F, 3.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(1, 267).addBox(-18.3992F, 2.7651F, 38.146F, 2.0F, 2.0F, 11.0F, new CubeDeformation(0.0F))
		.texOffs(1, 267).addBox(15.6009F, 2.7651F, 38.146F, 2.0F, 2.0F, 11.0F, new CubeDeformation(0.0F))
		.texOffs(166, 0).mirror().addBox(-22.7992F, -1.2349F, -24.854F, 3.0F, 2.0F, 44.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(270, 265).mirror().addBox(-22.9992F, -1.2349F, -52.854F, 3.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(210, 168).addBox(-20.7992F, -1.2349F, -54.954F, 41.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(186, 91).addBox(-20.7992F, 5.7651F, -52.154F, 41.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(210, 150).addBox(-20.2992F, 2.7651F, -51.854F, 40.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(100, 248).addBox(3.7008F, 2.5151F, -5.854F, 10.0F, 4.0F, 12.0F, new CubeDeformation(0.0F))
		.texOffs(98, 46).addBox(16.7008F, -7.2349F, -20.854F, 1.0F, 14.0F, 43.0F, new CubeDeformation(0.0F))
		.texOffs(118, 103).addBox(14.7008F, -3.2349F, -22.854F, 3.0F, 2.0F, 45.0F, new CubeDeformation(0.0F))
		.texOffs(156, 229).addBox(-15.2992F, -3.2349F, 15.146F, 30.0F, 9.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(98, 46).mirror().addBox(-18.2992F, -7.2349F, -20.854F, 1.0F, 14.0F, 43.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(118, 103).mirror().addBox(-18.2992F, -3.2349F, -22.854F, 3.0F, 2.0F, 45.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(100, 248).addBox(-15.2992F, 2.5151F, -5.854F, 10.0F, 4.0F, 12.0F, new CubeDeformation(0.0F))
		.texOffs(228, 235).addBox(-17.2992F, 2.7651F, -50.854F, 33.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(260, 34).addBox(-7.2992F, 3.2651F, 26.646F, 14.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(76, 237).addBox(-16.2992F, 3.7651F, 27.146F, 34.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(260, 34).addBox(-7.2992F, 3.2651F, -36.354F, 14.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(76, 237).addBox(-16.2992F, 3.7651F, -35.854F, 34.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(0, 150).addBox(-19.7742F, -7.2849F, -51.254F, 39.0F, 1.0F, 21.0F, new CubeDeformation(0.0F)), PartPose.offset(0.2992F, 10.2349F, 6.854F));
		...
		.texOffs(274, 80).addBox(18.0F, -7.0F, -1.0F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.7992F, 1.4151F, -53.854F, -0.4014F, 0.0F, 0.0F));

		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 236).addBox(-17.0F, -3.0F, -1.0F, 35.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.7992F, 1.5151F, -53.904F, -0.4014F, 0.0F, 0.0F));

		PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(250, 201).addBox(-8.0F, -8.0F, -1.0F, 17.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.7992F, 2.0651F, -53.354F, -0.4014F, 0.0F, 0.0F));

		PartDefinition cube_r4 = body.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(234, 219).addBox(-17.0F, -3.0F, -1.0F, 35.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.7992F, -3.0849F, -51.054F, -0.4014F, 0.0F, 0.0F));

		PartDefinition cube_r5 = body.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(100, 244).addBox(-16.0F, -1.0F, -2.0F, 33.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.2992F, 4.7651F, -48.854F, -0.4014F, 0.0F, 0.0F));
		...
		.texOffs(100, 264).addBox(20.0F, -10.0F, 5.0F, 10.0F, 17.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.2992F, -4.4849F, 2.146F, -0.4014F, 0.0F, 0.0F));

		PartDefinition cube_r7 = body.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(210, 176).addBox(-19.0F, 0.0F, -2.0F, 40.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.2992F, 0.7651F, -53.154F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition left_door_r1 = body.addOrReplaceChild("left_door_r1", CubeListBuilder.create().texOffs(186, 46).mirror().addBox(-3.0F, 3.0F, -22.0F, 1.0F, 2.0F, 43.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-19.2992F, 1.7651F, -1.854F, 0.0F, 0.0F, -0.4014F));

		PartDefinition right_door_r1 = body.addOrReplaceChild("right_door_r1", CubeListBuilder.create().texOffs(216, 265).addBox(-2.0F, -5.0F, 38.0F, 1.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-18.2992F, 1.7651F, -1.854F, 0.0F, 0.0F, -0.384F));

		PartDefinition right_door_r2 = body.addOrReplaceChild("right_door_r2", CubeListBuilder.create().texOffs(186, 46).addBox(2.0F, 3.0F, -22.0F, 1.0F, 2.0F, 43.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(18.7008F, 1.7651F, -1.854F, 0.0F, 0.0F, 0.4014F));

		PartDefinition right_side_r1 = body.addOrReplaceChild("right_side_r1", CubeListBuilder.create().texOffs(260, 16).mirror().addBox(-2.0F, -5.0F, 38.0F, 3.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-18.2992F, 1.7651F, -1.854F, 0.0F, 0.0F, -0.4014F));
		...
		PartDefinition right_side_r3 = body.addOrReplaceChild("right_side_r3", CubeListBuilder.create().texOffs(0, 46).mirror().addBox(-2.0F, -4.0F, -24.0F, 3.0F, 9.0F, 46.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-19.0492F, 2.1151F, -1.854F, 0.0F, 0.0F, -0.4014F));
		...
		.texOffs(80, 267).mirror().addBox(-15.0F, 9.0F, -25.4F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition right_side_r5 = body.addOrReplaceChild("right_side_r5", CubeListBuilder.create().texOffs(260, 16).addBox(-1.0F, -5.0F, 38.0F, 3.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(17.7008F, 1.7651F, -1.854F, 0.0F, 0.0F, 0.4014F));

		PartDefinition right_side_r6 = body.addOrReplaceChild("right_side_r6", CubeListBuilder.create().texOffs(0, 46).addBox(-1.0F, -4.0F, -24.0F, 3.0F, 9.0F, 46.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(18.4508F, 2.1151F, -1.854F, 0.0F, 0.0F, 0.4014F));

		PartDefinition cube_r10 = body.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(112, 191).mirror().addBox(-1.0F, -4.0F, -1.0F, 2.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-18.9992F, -7.2349F, 48.146F, 0.0F, 0.0F, 0.384F));
		...
		.texOffs(254, 245).addBox(15.0F, 4.0F, 39.0F, 2.0F, 6.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.4008F, -6.2349F, -17.854F, 0.0F, 0.0F, -0.384F));

		PartDefinition right_door_r3 = body.addOrReplaceChild("right_door_r3", CubeListBuilder.create().texOffs(98, 146).addBox(12.0F, 9.0F, -24.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.7008F, -7.2349F, -17.254F, 0.0F, 0.0F, -0.384F));
		...
		.texOffs(120, 150).addBox(13.0F, 5.0F, -3.6F, 2.0F, 8.0F, 43.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.1008F, -7.2349F, -17.254F, 0.0F, 0.0F, -0.384F));
		...
		.texOffs(0, 241).addBox(36.0F, -4.0F, -34.0F, 2.0F, 2.0F, 24.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-19.2992F, -16.2349F, 9.146F, 0.384F, 0.0F, 0.0F));

		PartDefinition cube_r12 = body.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(274, 58).addBox(-3.0F, -7.0F, -11.0F, 7.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.2992F, 3.5151F, 5.146F, 0.384F, 0.0F, 0.0F));

		PartDefinition cube_r13 = body.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(156, 201).addBox(-37.0F, 1.0F, 3.0F, 38.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(17.7008F, -14.2349F, 32.146F, -0.4014F, 0.0F, 0.0F));
		...
		.texOffs(168, 244).addBox(35.0F, 1.0F, -8.0F, 2.0F, 1.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-18.2992F, -13.9849F, 32.896F, -0.4014F, 0.0F, 0.0F));
		...
		PartDefinition cube_r19 = body.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(214, 130).addBox(-18.0F, 4.0F, -12.0F, 35.0F, 17.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.2992F, -7.2349F, 35.146F, -0.4014F, 0.0F, 0.0F));
		...
		.texOffs(92, 275).addBox(35.0F, -1.0F, 0.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-18.2992F, -9.2349F, 16.146F, -0.7854F, 0.0F, 0.0F));
		...
		.texOffs(112, 172).addBox(35.0F, -4.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-18.2992F, -11.9849F, 21.146F, 0.384F, 0.0F, 0.0F));

		PartDefinition cube_r22 = body.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(0, 128).addBox(-22.0F, -1.0F, -7.0F, 44.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.2992F, 1.8651F, 45.846F, 0.384F, 0.0F, 0.0F));

		PartDefinition cube_r23 = body.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(210, 161).addBox(-21.0F, -1.0F, -1.0F, 44.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.2992F, -1.6349F, 47.846F, -0.4014F, 0.0F, 0.0F));
		...
		.texOffs(112, 191).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(18.4008F, -7.2349F, 48.146F, 0.0F, 0.0F, -0.384F));
		...
		.texOffs(108, 146).addBox(-1.0F, -0.8571F, -2.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.7008F, -4.6278F, -16.354F, 0.3927F, 0.0F, 0.0F));
		...
		.texOffs(30, 101).addBox(-0.75F, -3.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5492F, 1.0151F, -13.354F));
		...
		.texOffs(274, 72).addBox(-0.75F, -1.95F, -1.86F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(20.7008F, 4.4651F, -34.244F));
		...
		.texOffs(274, 72).mirror().addBox(-1.25F, -1.95F, -1.86F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-21.2992F, 4.4651F, -34.244F));
		...
		.texOffs(274, 72).addBox(-0.75F, -1.95F, -1.86F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(20.7008F, 4.4651F, 28.756F));
		...
		.texOffs(274, 72).mirror().addBox(-1.25F, -1.95F, -1.86F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-21.2992F, 4.4651F, 28.756F));
