...
public class HatRegistry {
    ...
    // ── Hats ─────────────────────────────────────────────────────────────────
    // Second argument controls who can wear this hat.
    // Omitting it (or using DEFAULT) means everyone has access.
    // Change to BETA_TESTER / ACHIEVEMENT / EVENT to lock the hat.
 
    public static final Item HAT_MENACING = registerItem("menacing", settings -> new Item(settings), HatSource.DEFAULT);
 
    // Baseball caps — most are default, alpha/beta are beta-tester exclusive
    ...
    // Discord/community hats — event rewards
    ...
    // Milestone/community caps — event or beta
    ...
    /**
     * Registers a hat item with an explicit {@link HatSource}.
     */
