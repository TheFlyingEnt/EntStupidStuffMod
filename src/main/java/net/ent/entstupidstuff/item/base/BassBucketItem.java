...
public class BassBucketItem extends MobBucketItem {
    public BassBucketItem(EntityType<? extends Mob> type, Fluid fluid, SoundEvent emptyingSound, Properties settings) {
