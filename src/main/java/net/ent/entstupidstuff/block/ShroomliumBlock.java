...
public class ShroomliumBlock extends Block implements Fertilizable {
	public static final MapCodec<ShroomliumBlock> CODEC = createCodec(ShroomliumBlock::new);

	@Override
	public MapCodec<ShroomliumBlock> getCodec() {
		return CODEC;
	}

	public ShroomliumBlock(AbstractBlock.Settings settings) {
		super(settings);
	}
